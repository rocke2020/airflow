...
class ReadXCom(msgspec.Struct, omit_defaults=True, tag=True):
    key: str


class GetConnection(msgspec.Struct, omit_defaults=True, tag=True):
    id: str


class GetVariable(msgspec.Struct, omit_defaults=True, tag=True):
    id: str
