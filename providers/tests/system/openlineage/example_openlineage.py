...
from airflow.providers.openlineage.utils.operator import OpenLineageTestOperator
...
with DAG(
    ...
    check_events = OpenLineageTestOperator(task_id="check_events", file_path="event.json")
